...
import CSSPropertyBuffer from './CSSPropertyBuffer.js';
import CSSPropertyDescriptors from './CSSPropertyDescriptors.js';
import FontSizeBuffer from './FontSizeBuffer.js';

import parser from '../../third-party/css-parser_forked_normalized';

import TextSizeGetter from '../DOM/TextSizeGetter';
...
class CSSPropertySetBuffer extends MemoryMapBuffer {
	...
	/**
	 * Populates the buffer with initial values from descriptors.
	 */
 ...
 *
 * Built as an immediately-invoked function expression.
