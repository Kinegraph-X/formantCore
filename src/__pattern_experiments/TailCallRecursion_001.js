...
//	var testFunction = this.getTestFunction();
	var branches = this.getBranches(this.test);
	
	return this.test.bind(this, branches, doCallTest);
}
...
TailCallRecursion.prototype.shouldCallTest = function(branches, doCallTest, arg) {
	...
	return branches[+(arg >= 0  && !!doCallTest(arg))];
}

TailCallRecursion.prototype.test = function(branches, doCallTest, arg) {
	return this.shouldCallTest(branches, doCallTest, --arg).call(this, branches, doCallTest, arg);
}
