/**
 * @def FlexGridComponent
 * @isGroup true
 * 
 * @CSSify styleName : FlexGridComponentHost/false
 * @CSSify styleName : FlexGridComponentTemplate/false
...
var FlexGridComponentDef = function(uniqueID, options, model) {
	...
	var slotDef = TypeManager.createComponentDef({
		host : TypeManager.createComponentDef({
			...
			]/**@CSSifyStyle componentStyle : FlexGridComponentTemplate */
		}, null, 'hostOnly')
	}, null, 'rootOnly');
	 ...
	 * 
	 * This def is the base-def for any FlexGridComponent instance
	 ...
	 * 		=> we have to take into account that there is a !second! def obj, which is injected directly into the FlexGridComponent ctor
	 * 		=> so the FlexGridComponent must then be extended through prototypal inheritance, and :
...
//			type : 'ComposedCompnent', 				// this is implicit, as we call the CompoundComponent ctor in the TabPanel ctor
			nodeName : 'FlexGridComponent'.toLowerCase() + '-component'/**@CSSifyStyle componentStyle : FlexGridComponentHost */
		}),
		lists : [
...
module.exports = FlexGridComponentDef;