...
BlockLayoutAlgo.prototype.resetInlineAvailableSpaceOffset = function() {
	this.availableSpace.inlineOffset = this.layoutNode._parent.availableSpace.inlineOffset + this.layoutNode.computedStyle.bufferedValueToNumber('paddingInlineStart');
}

BlockLayoutAlgo.prototype.resetBlockAvailableSpaceOffset = function() {
	this.availableSpace.blockOffset = this.layoutNode._parent.availableSpace.blockOffset + this.layoutNode.computedStyle.bufferedValueToNumber('paddingBlockStart');
}
...
BlockLayoutAlgo.prototype.setOffsets = function() {
	...
	console.log('block layoutAlgo => this.availableSpace', this.availableSpace);
...
//	console.log('this.layoutNode.computedStyle.bufferedValueToString("boxSizing")', this.layoutNode.computedStyle.bufferedValueToString('boxSizing'));
...
//		console.log('block layout algo => this.decrementInlineAvailableSpace', this.availableSpace);
	}
	
	this.setAvailableSpace(dimensions);
	console.log('block layout algo => this.setSelfDimensions_pre', this.availableSpace);
	console.log('block layout algo => this.decrementInlineAvailableSpace', summedInlinePaddings);
	this.decrementInlineAvailableSpace(summedInlinePaddings);
	console.log('block layout algo => this.setSelfDimensions_post', this.availableSpace);
