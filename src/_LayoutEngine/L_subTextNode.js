 ...
 */
var SubTextNode = function(layoutParentNode, textContent) {
...
//	this.populateAllComputedStyle(this.queryStyleUpdate(sourceDOMNodeAsView));
	...
	this.layoutAlgo = new SubTextLayoutAlgo(this, this.textContent);
	...
	// outside of the LayoutAlgo, as the work in the constructor would not be finished
	return {
